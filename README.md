...
Supported Attacks
Attack TypeDescriptionCropRemoves a portion of the imageResizeScales the image resolutionNoiseAdds Gaussian noiseCompressApplies JPEG compressionAllRuns all attacks sequentially
Tech Stack
...
bashgit clone https://github.com/YOUR_USERNAME/traitor-tracer.git
cd traitor-tracer
